...
pub use structural_pattern::{
    ...
    StructuralPreparationCache, calculate_monochromatic_reflection_geometry,
    calculate_structural_pattern, calculate_structural_pattern_dense,
    calculate_structural_pattern_dense_with_context, calculate_structural_pattern_jvp,
    calculate_structural_pattern_jvp_with_context, calculate_structural_pattern_vjp,
