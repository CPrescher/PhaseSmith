...
| IUCr anhydrous trirubidium citrate + Si 640b | Bruker D2 Phaser laboratory Cu Kα X-ray | source-translated common subset / Si-anchor diagnostic | 9.579 / 9.735; deposited GSAS 2.458 | qualified parity / remaining model gap | Legacy `LX` is corrected to the Lorentzian size axis and `shft=-8.7503` maps to -0.1080505 mm in the current PhaseSmith/GSAS-II displacement convention at the deposited radius; the legacy manual's physical shift variable has the opposite sign. All parity gates pass: Rwp delta 0.155 percentage points, correlation delta 0.00484, and Si-fraction delta 0.026 percentage points. Si-only displacement remains incompatible at -0.07519/-0.11031 mm and does not replace the direct source translation. | `validation/results/2026-08-13-campaign-iucr-trirubidium-citrate-si.json` |
| Citrate isotropic-width ablation | same potassium/rubidium patterns | phase-local model sufficiency | K: 23.965 -> 20.737 accepted; corrected Rb base: 9.579 | potassium finite-size pass / rubidium isotropic rejection | Potassium finite size remains full-rank and repeatable at 90.19 nm. After correcting rubidium `LX` and `shft`, every size/strain variant fails the three-start repeatability gate; the former 56.23 nm result is invalidated as compensation for missing source translation. | `validation/results/2026-08-13-citrate-isotropic-broadening-ablation.json` |
| Citrate orthorhombic-Stephens ablation | same potassium/rubidium patterns | phase-local anisotropic-width sufficiency | fixed source K: 23.925; corrected Rb: 9.571 | convention pass / physical insufficiency | Deposited Stephens remains negligible. A free common amplitude requires 94x/382x source values; rubidium reaches only 9.416%, and its size/Stephens combinations are not repeatable after translation correction. | `validation/results/2026-08-13-citrate-stephens-ablation.json` |
| Rubidium legacy-profile factorial | anhydrous rubidium pattern | source-term residual forensics | 18.338 -> 9.726 best subset; deposited GSAS 2.458 | translation correction / remaining low-angle gap | Source shift supplies 87.3% of the Shapley SSE gain and corrected `LX` 18.0%; Stephens is negligible and the signed deposited transparency term is detrimental. The legacy equation confirms that sign and shows positive `trns=1.30` has formally negative `mu_eff`; reversing it improves Rwp but no longer represents the deposited model. The best subset closes 73.19% of the former gap, with 65.8% of remaining SSE below 30°. | `validation/results/2026-08-13-citrate-rubidium-residual-forensics.json` |
| Rubidium 17–30° component audit | anhydrous rubidium pattern | low-angle conversion-fidelity forensics | local source 9.828; combined physical shape/background 4.977; deposited 2.711 | coupled conversion gap / no new model | No isolated position, `W`, `X`, FCJ, background, or peak-group intensity probe closes half of the local weighted-SSE gap. The combined probe closes 80.47% but remains above the deposited curve. The FCJ optimum is the pinned GSAS-II effective `SH/L=0.002` floor, not evidence for zero source divergence. | `validation/results/2026-08-13-citrate-rubidium-low-angle-forensics.json` |
| Rubidium source-reflection fidelity | anhydrous rubidium pattern | source-native structure/intensity translation | 1,197 source rows; 600 unique reflections | structure/intensity fidelity pass | Source Cromer–Mann coefficients plus converted structure reproduce 20 low-angle rubidium F² values with 0.0289% source-weighted L1 error and 0.0301% normalized RMS error. Production Waasmaier–Kirfel gives 0.301%/0.296%; measurable but far too small to explain the profile gap. | `validation/results/2026-08-13-citrate-rubidium-source-reflection-fidelity.json` |
| Rubidium source-axial fidelity | anhydrous rubidium pattern | source-native geometry / reduced-oracle translation | PhaseSmith native geometry exact; formal-sum GSAS-II max L1 17.53% | native conversion pass / oracle-shape limitation | PhaseSmith preserves `S/L=H/L=0.0097`, exactly matching its formal equal-height `SH/L=0.0194` mapping. The pinned one-parameter GSAS-II kernel is not shape-faithful there; the closer tested `0.0097` is not adopted as a physical conversion. | `validation/results/2026-08-13-citrate-rubidium-source-axial-profile-fidelity.json` |
...
| 2026-08-13 | IUCr anhydrous trirubidium citrate + NIST Si 640b | Corrected the equation translation of legacy `LX` and `shft`, then reran PhaseSmith and exact-revision GSAS-II. | PhaseSmith/GSAS-II reach 9.579/9.735% Rwp and pass every parity gate. The current-model displacement parameter is -0.1080505 mm; the opposite legacy physical-height sign and incompatible Si-window values are recorded explicitly. |
| 2026-08-13 | Potassium/rubidium citrate isotropic-width ablation | Reran rubidium after the source-translation correction while retaining the original potassium protocol. | Potassium's 90.19 nm solution remains accepted. No corrected-rubidium isotropic model is repeatable, invalidating the former 56.23 nm interpretation. |
| 2026-08-13 | Potassium/rubidium citrate Stephens ablation | Reran the fixed and scaled deposited-shape tests after correcting rubidium position/profile semantics. | Fixed Stephens changes corrected rubidium Rwp by only 0.008 percentage points; 382x source amplitude reaches 9.416%, and size combinations fail repeatability. |
| 2026-08-13 | Rubidium legacy-profile residual forensics | Ran all 16 combinations of legacy `LX`, `shft`, `trns`, and Stephens through pinned GSAS-II with fixed structure/instrument and exact scale/background solves. | Shift and `LX` explain most recoverable SSE. Transparency worsens the reconstruction; Stephens is negligible. Remaining error is concentrated below 30° and is more width-like than position-like. |
| 2026-08-13 | Rubidium 17–30° component audit | Reweighted the full 4,106-point project to the 643-point low-angle interval and ran physical fixed scans plus background, shift, peak-group-amplitude, and moment probes. | No single component closes half the local gap. Width/axial/background effects combine strongly but do not reach the deposited curve, so source-native intensity and profile-function-4 fidelity is next. |
| 2026-08-13 | Rubidium source-reflection fidelity | Preserved all deposited reflection rows and compared their calculated F² with the converted structures under both source Cromer–Mann and production Waasmaier–Kirfel scattering. | Structure, symmetry, ADPs, d-spacing, and source scattering reproduce the low-angle intensities. The production table contributes only a 0.301% weighted intensity difference; profile-function-4 shape remains next. |
| 2026-08-13 | Rubidium source-axial fidelity | Compared three isolated source-geometry profiles with pinned GSAS-II at its floor, one deposited ratio, and the documented formal sum. | PhaseSmith's native geometry is exact. Pinned GSAS-II at the formal sum differs by up to 17.53% normalized L1, so empirical one-parameter tuning is rejected and no production term is added. |
