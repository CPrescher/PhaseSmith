...
| IUCr anhydrous trirubidium citrate + Si 640b | Bruker D2 Phaser laboratory Cu Kα X-ray | source-qualified holdout | —; deposited GSAS 2.458 | registered / converter next | The checksum-pinned `vn2123sup1.cif` contains 4,701 counts, a contiguous 4,106-point deposited range, both structures, 2.15 wt% Si, a deposited 141.5 mm radius, no roughness correction, and a common base profile for both phases. This is the next rubidium implementation case. | [IUCr article](https://journals.iucr.org/e/issues/2017/02/00/vn2123/) |
