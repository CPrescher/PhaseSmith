...
| IUCr sodium dihydrogen citrate polymorph + Si 640b | Bruker D2 Phaser laboratory Cu Kα X-ray | source-qualified preferred-orientation holdout | 15.722 / pending; deposited GSAS 8.433 | native pass, oracle blocked | The checksum-pinned `hb7585sup1.cif` converts 4,452 refined points and both phases. Fixed-cell Si calibrates displacement to -0.133 mm (conditional on the disclosed 141.5 mm radius assumption). A one-axis March--Dollase approximation gives correlation 0.97163 and 21.509 wt% Si versus 18.74 wt% deposited; generalized spherical-harmonic orientation, Stephens width, and Suortti roughness remain explicitly unmatched. | [IUCr article](https://journals.iucr.org/e/issues/2016/06/00/hb7585/index.html) |
