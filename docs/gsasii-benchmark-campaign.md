...
| IUCr anhydrous tripotassium citrate + Si internal standard | Bruker D2 Phaser laboratory Cu Kα X-ray | source-qualified holdout | — | conversion complete | The checksum-pinned `wm5301sup1.cif` converts its contiguous 2,696-point deposited range, both structures, and legacy curve; the converter reproduces deposited Rwp 4.853%. The source fixes Si a=5.43105 Å but does not identify a NIST SRM. The 1.44 wt% Si anchor and common-model refinement remain under review. | [IUCr article](https://journals.iucr.org/e/issues/2016/08/00/wm5301/index.html) |
...
| 2026-08-13 | IUCr anhydrous tripotassium citrate + Si internal standard | Registered and converted the official supplementary pdCIF, including exact deposited mask and residual checks. | Conversion passes for 2,696 points with legacy Rwp 4.853% and 1.44 wt% Si; numerical workflow and oracle gates remain pending. |
