...
| IUCr anhydrous trirubidium citrate + Si 640b | Bruker D2 Phaser laboratory Cu Kα X-ray | source-qualified holdout | —; deposited GSAS 2.458 | conversion complete | The checksum-pinned `vn2123sup1.cif` converts all 4,701 counts to the exact contiguous 4,106-point deposited range after the 5–17° beam-spillover exclusion. Both structures, 2.15 wt% Si, the deposited 141.5 mm radius, equal axial ratios, no roughness correction, and the common base profile are retained; the converter reproduces deposited Rwp 2.458%. | [IUCr article](https://journals.iucr.org/e/issues/2017/02/00/vn2123/) |
