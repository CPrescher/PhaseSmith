...
provenance.
Per-bank provenance now binds the source bank number to the exact public
`bank_id`, and request validation requires provenance order to align with bank
order. Length-only provenance attachment is rejected.
